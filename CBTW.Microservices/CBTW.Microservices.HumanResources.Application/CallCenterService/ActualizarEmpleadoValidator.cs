...
public class ActualizarEmpleadoValidator : AbstractValidator<ActualizarEmpleadoRequest>
{
    public ActualizarEmpleadoValidator(CancellationToken cancellationToken = default(CancellationToken))
    {
