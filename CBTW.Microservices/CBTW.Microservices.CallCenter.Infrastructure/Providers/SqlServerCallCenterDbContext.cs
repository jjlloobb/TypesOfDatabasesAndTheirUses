...
public partial class SqlServerCallCenterDbContext : DbContext
{
    public SqlServerCallCenterDbContext(DbContextOptions<SqlServerCallCenterDbContext> options)
        : base(options)
    {
    }
